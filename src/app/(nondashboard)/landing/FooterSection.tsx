    ...
    <footer className="border-t border-gray-200 py-20">
      <div className=" max-w-4xl mx-auto px-6 sm-px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4">
            <Link 
            href="/" className="text-xl font-bold" 
            scroll={false}>
              <div className="tracking-wide">
                <span className="text-black">RENT</span>
                <span className="text-xl font-bold text-secondary-500  hover:text-primary-300 transition-colors duration-200">
                  NQB
                </span>
              </div>
            </Link>
      ...
      <div className="text-center mt-8 text-sm text-gray-500 flex justify-center space-x-4">
        <span>© RENTNQB. All Rights Reserved</span>
